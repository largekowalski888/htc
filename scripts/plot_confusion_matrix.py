...
if __name__ == '__main__':
    ...
    parser.add_argument('--run-dir', required=True, type=str, help='Directory containing test_table.pkl.xz and config.json')
    parser.add_argument('--title', default='', type=str, help='Optional plot title override')
