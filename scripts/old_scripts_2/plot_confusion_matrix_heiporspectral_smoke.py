...
run_dir = Path("C:/DKFZ/outputs/heiporspectral_smoke_run")
...
ax.set_ylabel("true")
ax.set_title("HeiPorSPECTRAL Smoke-Test Confusion Matrix")

plt.savefig(run_dir / "heiporspectral_smoke_confusion_matrix.png", dpi=200)
plt.show()

print(df_metrics[["subject_name", "accuracy"]])
