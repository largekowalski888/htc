...
run_dir = Path(r"C:\DKFZ\outputs\cat_kidney_positive_scaffold_20class")
...
ax.set_ylabel('true')
ax.set_title('CAT Kidney-Positive Scaffold Confusion Matrix (20-class HeiPorSPECTRAL label space)')
plt.xticks(rotation=70)
plt.yticks(rotation=0)
plt.savefig(run_dir / 'cat_kidney_positive_scaffold_20class_confusion_matrix.png', dpi=200)
plt.show()
