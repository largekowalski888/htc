...
The figures for this paper are created via the notebooks in [`paper/NatureBME2026`](../NatureBME2026). Run the [paper/NatureBME2026/DomainShiftPerformance.ipynb](../NatureBME2026/DomainShiftPerformance.ipynb) notebook now and you should get an error about missing paths.
...
```bash
HTC_MODEL_TIMESTAMP="<YOUR_TIMESTAMP>" find paper/NatureBME2026 -name "*.ipynb" -exec jupyter nbconvert --to html --execute --stdout {} > /dev/null \;
HTC_MODEL_TIMESTAMP="<YOUR_TIMESTAMP>" htc NatureBME2026.generate_variables
```
